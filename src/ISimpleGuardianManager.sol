...
interface ISimpleGuardianManager {
    /**
    ...
    struct GuardianConfig {
       ...
       event AddedGuardian(address indexed account, address indexed guardian, uint256 weight, GuardianType guardianType);
    ...
    function addGuardian(address guardian, uint256 weight, GuardianType guardianType) external;
